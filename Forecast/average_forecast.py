...
# Another way of showing mean absolute error
rrors = naive_forecast - x_valid
...
"""We see that the mean absolute error of the moving average is a bit worse than the naive"""
